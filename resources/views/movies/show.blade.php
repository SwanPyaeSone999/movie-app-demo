...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container  mx-auto px-6 mt-10">
            <div class="flex gap-8 md:flex-row flex-col">
                <img class="object-cover w-full object-center md:w-4/5 "
                    src="{{ $show['poster_path'] }}" alt="">
                <div class="md:ml-10 mt-5">
                    <div class="space-y-2 ">
                        <h1 class="text-xl  font-sans tracking-wider">{{ $show['title'] }}</h1>
                        <div>
    ...
    {{-- cast preview --}}
    <div class="cast-info container mx-auto px-6 mt-10">
        ...
        <div class="grid  grid-cols-3 md:grid-cols-4  mt-5 gap-4 w-full  rounded-sm">
            @foreach ($show['cast'] as $cast)
                    <div class="mt-2">
                        ...
                        <div class="text-sm font-semibold mt-1">{{ $cast['name'] }}</div>
                    </div>
            @endforeach
        </div>
    </div>
